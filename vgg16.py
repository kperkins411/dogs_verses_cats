...
class Vgg16():
    ...
    def ft(self, num, checkpointfile = None):
        """
        ...
        #load from checkpoint if checkpointfile given
    ...
    def finetune(self, batches, checkpointfile = None):
        """
        ...
        """
        number_classes=len(batches.class_indices)
        self.ft(batches.num_class, checkpointfile = checkpointfile)
    ...
    def fit(self, batches, val_batches, nb_epoch=1, callbacks = None):
        ...
        self.model.fit_generator(batches, samples_per_epoch=batches.samples, nb_epoch=nb_epoch,
                validation_data=val_batches, nb_val_samples=val_batches.samples, callbacks = callbacks)
    ...
    def test(self, path, batch_size=8, verbose =0):
        ...
        return test_batches, self.model.predict_generator(test_batches, test_batches.samples, verbose = verbose)

    def getAccuracy(self):
        if self.model == None:
            raise ValueError("Please initialize model before calling this function")
